...
class BlurExample extends React.Component {
  ...
  // Мы закрываем выпадающий список в следующем тике с помощью setTimeout.
  // Сначала необходимо убедиться, что другой дочерний элемент
  // не получил фокус, поскольку событие blur сработает до события focus.
  onBlurHandler() {
